...
public class CursoServiceImpl implements CursoService{
	...
	@Override
	public List<Alumnos> listaAlumnosCurso(int idcurso) {
		...
		try(Connection con = ConnectionLocator.getConnection();){
			...
			while (rs.next()) {		
				...
				Alumnos alumno=new Alumnos(dni, nombre, email, nota, curso);  // quiero que nota pueda guardarse como nulo
				alumnos.add(alumno);				
			}	
		}
		catch(SQLException ex) {
	...
	@Override
	public void AltaAlumnoCurso (String dni, String  nombre, String email,  int idcurso) {
		try(Connection con = ConnectionLocator.getConnection();){
			String sql="insert into alumnos (idalumno, nombre, email, idcurso) values (?,?,?,?)";
			PreparedStatement ps = con.prepareStatement(sql);	
			ps.setString(1, dni);	
	...
	public void AltaAlumnoCursoNota (String dni, String  nombre, String email,Double nota,   int idcurso) {
		try(Connection con = ConnectionLocator.getConnection();){
